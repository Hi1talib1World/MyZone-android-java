package com.example.myzone.ui.dashboard;
...
public class DashboardFragment extends Fragment implements SwipeStack.SwipeStackListener, View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mButtonLeft = (Button) root.findViewById(R.id.buttonSwipeLeft);
        mButtonRight = (Button) root.findViewById(R.id.buttonSwipeRight);
        mFab = (FloatingActionButton) root.findViewById(R.id.fabAdd);
