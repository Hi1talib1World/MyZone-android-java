package com.example.myzone.ui.dashboard.swipestack;
...
public class SwipeStack extends ViewGroup {
    ...
    private link.fls.swipestack.SwipeStack.SwipeStackListener mListener;
    private link.fls.swipestack.SwipeStack.SwipeProgressListener mProgressListener;
     ...
     * @param listener The callback that will run
     */
    public void setSwipeProgressListener(@Nullable link.fls.swipestack.SwipeStack.SwipeProgressListener listener) {
